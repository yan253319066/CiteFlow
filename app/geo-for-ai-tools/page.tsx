...
export const metadata: Metadata = { title: 'GEO for AI Tools | CiteFlow', description: 'Coming soon.', robots: { index: false }, alternates: { canonical: 'https://www.getciteflow.ai/geo-for-ai-tools' } };
