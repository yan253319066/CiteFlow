...
export const metadata: Metadata = {
  title: 'GEO for AI Tools | CiteFlow',
  ...
  openGraph: { title: "GEO for AI Tools | CiteFlow", description: "Optimize your AI tool for AI citations.", url: 'https://www.getciteflow.ai/geo-for-ai-tools', type: 'article' },
};
