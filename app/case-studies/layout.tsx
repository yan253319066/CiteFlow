...
export const metadata: Metadata = {
  title: 'GEO Case Studies | GetCiteFlow',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.getciteflow.ai/api/og?domain=getciteflow.ai/case-studies&score=75', width: 1200, height: 630, alt: 'GetCiteFlow Case Studies OG Image' }],
  },
  twitter: {
