...
export const metadata: Metadata = {
  ...
  openGraph: { title: "GEO for Startups | GetCiteFlow", description: "Build AI visibility for your startup.", url: 'https://www.getciteflow.ai/geo-for-startups', type: 'article' },
};
