...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'GEO for Startups | GetCiteFlow', description: 'Learn how startups can build AI visibility from day one. Strategies for getting your startup mentioned by ChatGPT, Gemini, and AI search.', images: ['https://www.getciteflow.ai/api/og?domain=getciteflow.ai/geo-for-startups&score=75'] },
};
