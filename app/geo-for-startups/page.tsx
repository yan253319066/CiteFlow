...
export const metadata: Metadata = { title: 'GEO for Startups | CiteFlow', description: 'Coming soon.', robots: { index: false }, alternates: { canonical: 'https://getciteflow.ai/geo-for-startups' } };
