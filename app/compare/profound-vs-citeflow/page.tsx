...
export const metadata: Metadata = { title: 'Profound vs CiteFlow | CiteFlow', description: 'Coming soon.', robots: { index: false }, alternates: { canonical: 'https://getciteflow.ai/compare/profound-vs-citeflow' } };
