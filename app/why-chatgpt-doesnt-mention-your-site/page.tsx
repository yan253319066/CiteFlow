...
export const metadata: Metadata = { title: 'Why ChatGPT Doesn\'t Mention Your Site | CiteFlow', description: 'Coming soon.', robots: { index: false }, alternates: { canonical: 'https://www.getciteflow.ai/why-chatgpt-doesnt-mention-your-site' } };
