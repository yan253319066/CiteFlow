...
export const metadata: Metadata = { title: 'GEO for SaaS | CiteFlow', description: 'Coming soon.', robots: { index: false }, alternates: { canonical: 'https://www.getciteflow.ai/geo-for-saas' } };
