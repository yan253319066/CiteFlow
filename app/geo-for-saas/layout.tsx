...
export const metadata: Metadata = {
  ...
  openGraph: { title: "GEO for SaaS | CiteFlow", description: "Optimize your SaaS product for AI citations.", url: 'https://www.getciteflow.ai/geo-for-saas', type: 'article' },
};
