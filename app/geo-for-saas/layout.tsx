...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'GEO for SaaS | GetCiteFlow', description: 'Learn how to optimize your SaaS product for AI citations in ChatGPT, Perplexity, and Gemini. Specific strategies for software companies.', images: ['https://www.getciteflow.ai/api/og?domain=getciteflow.ai/geo-for-saas&score=75'] },
};
