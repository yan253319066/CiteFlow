...
export const metadata: Metadata = {
  ...
  description: 'A managed service that builds your brand\'s presence across AI systems — ChatGPT, Claude, Gemini, Perplexity, DeepSeek, Doubao. Industry-specific platform strategy, brand entity building, citation-optimized content, and more. From $4,999/month.',
  ...
  openGraph: {
    title: 'AI Visibility Growth Service | GetCiteFlow',
    description: 'Build your brand\'s presence across ChatGPT, Claude, Gemini, Perplexity, DeepSeek, and Doubao with a managed visibility growth service.',
